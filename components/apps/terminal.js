...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["projects", "research", "skills", "experience", "education", "interests"],
            education: ["LNMIIT-Jaipur-BTech-CSE.txt"],
            research: ["biometric-deep-embeddings.pdf", "wavelet-artifact-detection.pdf"],
            skills: ["C++", "Python", "Deep-Learning", "Computer-Vision", "PyTorch", "OpenCV", "React.js", "Node.js", "Express.js", "MongoDB", "MySQL", "Docker", "Linux"],
            projects: ["OpenSeek-Browser-Ext", "Face-Recognition-Model-Python", "Spardha-Tournament-Platform", "Ubuntu-OS-Portfolio"],
            experience: ["Doggle-India-Shopify-MERN.txt", "LNMIIT-Research-Lab-Deep-Learning.txt"],
            interests: ["Computer Vision", "Deep Learning", "Systems Architecture", "Deterministic Algorithms"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">yashbansal</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/yashbansal");
                break;
            case "whoami":
                result = "yashbansal - Software Developer & Programmer";
                break;
            case "cat":
                if (rest === "LNMIIT-Jaipur-BTech-CSE.txt") {
                    result = "The LNM Institute of Information Technology (LNMIIT), Jaipur<br>B.Tech in Computer Science and Engineering (2022-2026)";
                } else if (rest.includes("Doggle")) {
                    result = "Shopify & MERN Stack Developer at Doggle India (2026 - Present)<br>Building eCommerce systems, custom Liquid components, and REST APIs.";
                } else if (rest.includes("LNMIIT-Research")) {
                    result = "Research Developer (Deep Learning) at LNMIIT Research Lab (2026)<br>Researched CNN architectures for biometric detection and feature vector cosine similarity.";
                } else {
                    result = `cat: ${rest || "file"}: No such file or directory`;
                }
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, cat, whoami, echo, clear, exit, mkdir, code, spotify, chrome, about-yash, openseek, trash, settings, sendmsg ]";
                }
                break;
            case "echo":
